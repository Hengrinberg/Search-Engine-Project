...
//		ReadFile2 read_file_obj = new ReadFile2(input_path, output_path);
//		System.out.println("Debugger : file reader finished");
//		System.out.printf("Number of files in corpus = %d", read_file_obj.dbg_count_files);
		
		Parser parse = new Parser("E:\\sahar_java_project\\output");
	}
